...
<?php
        ...
        $sql="select * from service_details where vendor_id='$vendorid' AND service_id='6'";
        $result = mysqli_query($db,$sql);
        ...
        $sql="update entertainment set requirements='$array[1]',programs='$array[2]' where vendor_id='$vendorid'";
        ...
        $sql="update service_details set service_name='$name', location='$location', contact='$contact' where vendor_id='$vendorid' AND service_id='6'";
        $result = mysqli_query($db,$sql);
...
<div class="container">        
    <form action="" metho="post">
        ...
        <label>Contact</label><input type='number' name='contact' value="<?php echo $info[4];?>" ><br>
            <label>Requirements:</label><input type ='text' name = "1" placeholder="<?php echo $array[1];?>" id="discr" class = "box" /><br/><br />
    <label>Programs:</label><input type ='text' name = "2" id="location" placeholder="<?php echo $array[2];?>" class = "box"  /><br/><br />
