...
<?php
        ...
        $sql="select * from service_details where vendor_id='$vendorid' AND service_id='7'";
        $result = mysqli_query($db,$sql);
        ...
        if(isset($_GET['submit']))
        {
            ...
            $sql="update decoration set patterns='$array[1]',flowers='$array[2]',lightandsound='$array[3]' where vendor_id='$vendorid'";
            ...
            $sql="update service_details set service_name='$name', location='$location', contact='$contact' where vendor_id='$vendorid' AND service_id='7'";
            $result = mysqli_query($db,$sql);
...
<div class="container">        
    ...
    <label>patterns</label><input type ='text' name = "1" id="location" placeholder="<?php echo $array[1];?>" class = "box"  /><br/><br />
    <label>flowers</label><input type ='text' name = "2" id="contact" placeholder="<?php echo $array[2];?>" class = "box" /><br/><br />
    <label>lightandsound</label><input type ='text' name = "3" id="rate" class = "box" placeholder="<?php echo $array[3];?>"  /><br/><br />
