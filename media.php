...
<?php
        ...
        $sql="select * from service_details where vendor_id='$vendorid' AND service_id='3'";
        $result = mysqli_query($db,$sql);
        ...
        $sql="update media set type='$array[1]',equipment='$array[2]',album='$array[3]' where vendor_id='$vendorid'";
        ...
        $sql="update service_details set service_name='$name', location='$location', contact='$contact' where vendor_id='$vendorid' AND service_id='3'";
        $result = mysqli_query($db,$sql);
...
<div class="container">        
    ...
    <label>Type:</label><input type ='text' name = "1" id="location" placeholder="<?php if(isset($array)){ echo $array[1];}?>" class = "box"  /><br/><br />
    <label>Equipment:</label><input type ='text' name = "2" id="contact" placeholder="<?php if(isset($array)){ echo $array[2];}?>" class = "box" /><br/><br />
    <label>album</label><input type ='text' name = "3" id="rate" class = "box" placeholder="<?php if(isset($array)){ echo $array[3];}?>"  /><br/><br />
