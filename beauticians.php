...
<?php
        ...
        $sql="select * from service_details where vendor_id='$vendorid' AND service_id='5'";
        $result = mysqli_query($db,$sql);
       ...
       if(isset($_GET['submit'])){
        ...
        $sql="update beauticians set bridal='$array[1]',prebridal='$array[2]' where vendor_id='$vendorid'";
        ...
        $sql="update service_details set service_name='$name', location='$location', contact='$contact' where vendor_id='$vendorid' AND service_id='5'";
        $result = mysqli_query($db,$sql);
...
<div class="container">        
    ...
    <label>bridal</label><input type ='text' name = "1" id="location" placeholder="<?php if(isset($array)){ echo $array[1];}?>" class = "box"  /><br/><br />
    <label>prebridal</label><input type ='text' name = "2" id="contact" placeholder="<?php if(isset($array)){ echo $array[2];}?>" class = "box" /><br/><br />
