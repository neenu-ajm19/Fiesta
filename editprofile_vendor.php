...
if(isset($_POST['submit']))
{
        ...
        $q1="update vendor_details set vendor_name='$name', vendor_password=PASSWORD('$pass') where vendor_id='$vendorid'";
        ...
        if($_POST['pass']==$_POST['cpass'])
        {
            $r1=mysqli_query($db,$q1);
                    ...
                    // if everything is ok, try to upload file
                        ...
                        if (move_uploaded_file($_FILES["ftp"]["tmp_name"],$target_dir .$vendorid.".jpg")) {
