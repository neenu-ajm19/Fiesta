   ...
   if(isset($_SESSION["userid"]))
{
  header("location:user_dash.php");
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") 
   {
      ...
      $sql = "SELECT * FROM user_details WHERE user_id = '$myusername' and user_password = PASSWORD('$mypassword')";
...
<div class="container">
   ...
   <div class="row">
      ...
      <div class="col s8">
        <a href="user_signup.php"><h6>Dont have an account? REGISTER</h6></a>
         <div class="card">
            <div class="card-content">
               ...
               <form action = "" method = "post">
				  ...
				  <div>
					<h6><a href="forgot_user.html">Forgot Password?</a></h6>
				</div>
               </form>
            </div>
         </div>
