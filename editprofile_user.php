...
if(isset($_POST['submit'])){
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["ftp"]["tmp_name"],$target_dir ."$userid.jpg")) {
    ...
    $q1="update user_details set user_name='$name', contact='$contact', user_password=PASSWORD('$pass') where user_id='$userid'";
            ...
            <div class="card-content">
               ...
               <form action = "" method = "post" enctype='multipart/form-data'>
                  <div class="input-field">
                     <label >Name</label>
                     <input type = "text" name = "name" class = "validate" id="username" required/><br /><br />
                  </div>
                    <div class="input-field">
                     
                     <label>Contact</label><input type='text' name='contact' class = "validate" id="username" required/><br /><br />
                  </div>
                  ...
                  <div class="input-field">
                     ...
                     <input type = "password" name = "pass" class = "validate" id="password"required /><br/><br />
                  </div>
                  <div class="input-field">
                     <label>Confirm Password</label>
                     <input type ='password' name = "cpass" id="cpassword" class = "validate" required /><br/><br />
                  </div>
                  <div class="input-field">
