...
if(isset($_POST['email']))
{
  ...
  if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
	...
	{
		$sql="insert into vendor_details values ('$_POST[email]','$_POST[username]',PASSWORD('$_POST[password]'))";
		$result = mysqli_query($db,$sql);
		if($result)
		{
			echo "<script>
			alert('Vendor has been registered, you will be redirected to the login page');
...
<div class="container">
   ...
   <div class="row">
      ...
      <div class="col s8">
        <a href="vendor_login.php"><h6>Have an account? LOGIN</h6></a>
         <div class="card">
